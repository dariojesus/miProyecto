...
<head>
    ...
    <title><?php echo $palabras[21] ?></title>
    ...
    <main>
        ...
        <div id="tabla">
            <div style="background-color: black;">
                <?php echo CHTML::link(
                    CHTML::imagen("../../../imagenes/iconos/agregar_vuelo.png"),
            ...
            <table class="table table-striped table-hover" id="tablaVuelos">
                ...
                <tbody>
                    ...
                    foreach ($vuelos as $clave => $vuelo) {
                        ...
                        $ventana = new CModal(
                            "vuelo" . $vuelo["cod_vuelo"],
                             $palabras[16],
                            "{$palabras[17]}<b>
                                          <br>{$palabras[11]}: {$vuelo["compannia"]}
