    ...
    <main>
        ...
        <fieldset>
            ...
            <div class="form-floating m-2">
                ...
                <label for="contra"><?php echo $palabras[11]; ?></label>
            </div>
            <div class="form-floating m-2">
                ...
                echo CHTML::campoLabel($palabras[12],"rol").PHP_EOL;
            ...
            <?php
            echo CHTML::campoBotonSubmit($palabras[13], ["class" => "btn btn-outline-success w-50"]) . PHP_EOL;
            ?>
