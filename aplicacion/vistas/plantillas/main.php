...
<head>
	...
	switch ($this->lang){
			...
			default: $palabras = ["Iniciar sesión","Mi cuenta","Inicio","Viajes","Gestión de viajes","Gestión de usuarios","Logout",
										"Sobre nosotros","Protección de datos y cookies","Condiciones de uso","Autor"];
										
					echo '<script src="/javascript/IA.js" id="botcopy-embedder-d7lcfheammjct" class="botcopy-embedder-d7lcfheammjct" data-botId="607ade552391c1000862b999" defer></script>'.PHP_EOL;
					break;
	};
	?>
</head>
